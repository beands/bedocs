...
export interface ComponentSlotWrapper {
  content: string;
  /** File name (no extension) under `.bedocs/src/generated/component-slots/`. */
  name: string;
}
...
export interface ComponentSlotPlan {
  ...
  /** Contents of `.bedocs/src/generated/components.ts`. */
  module: string;
  wrappers: ComponentSlotWrapper[];
}

const EMPTY_MODULE = `// Generated by BeDocs. Do not edit.
import type { ComponentOverride } from "@beands/bedocs/core/define-components.ts";
...
export const planComponentSlots = (
  ...
  if (!analysis) {
    return {
      frameworks,
      module: `// Generated by BeDocs. Do not edit.
...
`,
  ...
  const moduleSource = `// Generated by BeDocs. Do not edit.
import overrides from ${JSON.stringify(componentsFile)};
