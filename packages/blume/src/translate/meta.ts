    ...
    for (const file of files.toSorted()) {
      ...
      if (typeof mod === "function") {
        diagnostics.push({
          ...
          file,
          message:
            "This meta file default-exports a function, so `bedocs translate` cannot generate per-locale copies of it.",
          severity: "warning",
          suggestion:
...
export const generateMetaModule = (
  ...
  return [
    "// Generated by `bedocs translate` — edit the default locale's meta file",
