 ...
 * with their exact configured status. On a server build BeDocs routes
 ...
 * route: BeDocs serves every page from `[...slug]`, so it never does, and
...
export const buildNegotiationWorker = (
  ...
  return `// Generated by BeDocs. Do not edit; this file is recreated on each build.
//
