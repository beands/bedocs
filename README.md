...
- **AI-генерация через [crea-ai.ru](https://crea-ai.ru/)** — автоматическое создание структурированной документации из сырых Markdown файлов с помощью Gemini моделей. RAG-анализ, поэтапный план, генерация и пересборка.
