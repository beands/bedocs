...
- **AI-генерация через crea-ai** — автоматическое создание структурированной документации из сырых Markdown файлов с помощью Gemini моделей. RAG-анализ, поэтапный план, генерация и пересборка.
