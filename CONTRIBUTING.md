...
- `admin/` — admin-панель для управления проектами и AI-генерации через crea-ai
...
7. **API-ключи** — никогда не коммитьте `admin/settings.json` или `settings.json` с реальными API-ключами. Файлы добавлены в `.gitignore`.
